...
class FindPwView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        addSubview(emailSendImageView)
        addSubview(emailTextField2)
        addSubview(codeSendLabel)
        
        addSubview(codeSendImageView)
        addSubview(codeTextField)
        addSubview(codeConfirmLabel)
        ...
        addSubview(pwCheckImageView)
        addSubview(passwordCheckTextField2)
        addSubview(pwValidLabel)
        
        addSubview(nextBtnImageView2)
        addSubview(pwChangeBtn)
        addSubview(pwSameLabel)
        
        addSubview(emailCodeBtn)
        addSubview(codeConfirmBtn)
